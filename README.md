...
- Membuat migrasi model dengan menjalankan perintah "python manage.py makemigrations" untuk membuat file migrasi yang berisi perubahan model 
...
- Pilih versi pyhton yang digunakan dan pada bagian start command ketik (python manage.py migrate && gunicorn pacil_lib.wsgi)
